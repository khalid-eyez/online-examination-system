...
use yii\helpers\Url;
use frontend\modules\admin\models\RegisterInstructorForm;
...
<div class="modal fade" id="instructormodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
     <div class="modal-header bg-success pl-4 p-2"><div class="modal-title ml-1"><i class='fa fa-plus-circle'></i> Register Instructor</div></div>
      <div class="modal-body">
        ...
        <section class="col-md-12">
              ...
              <?php $form = ActiveForm::begin(['action'=>"create-instructor",'method'=>'post'])?>
                 ...
                 <div class="col-sm-6">
                   ...
                   <div class="row">
                    <div class="col-sm-12">
                     ...
                     <?= Html::submitButton('<i class="fa fa-save"></i> Save', ['class'=>'btn btn-success btn-md float-right mr-0']) ?>
