    ...
    <div class="modal-header bg-success pt-2 pb-2">
      ...
      <div class="modal-body">
        <div class="container-fluid questionwidget">
                 <form enctype="multipart/form-data" method="post" action="save-question">
                 ...
                 <select class="form-control float-right questiontype" name="questiontype" required>
                 <option value="" name="questiontype" disabled selected>--Choose Type--</option>
               ...
               <div class="row  ml-2 p-0 material-background">
                ...
                <div class="col-sm-11 m-0">
                  ...
                  <span class="float-right"><button type="submit"  class="btn btn-default btn-md shadow bg-success submit_btn"><i class="fa fa-save"></i> Save</button></span>
                  </div>
                  </div>
                  </div>
...
$('.questiontype').on('change',function(){
  ...
  else if($('.questiontype').val()=="multiple-choice")
  {
    ...
    if(changecount<2)
    {
    Swal.fire('Important','Dear Instructor, Imagine if the student checks all options; he/she may get undeserved maximum score; to solve that, you are advised to put a negative score for incorrect options !','info');
    }
  }
